...
class DistrictPickerScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<DistrictPickerScreen> createState() =>
      _DistrictPickerScreenState();
}
        ...
        children: [
          ...
          Expanded(
            child: RefreshIndicator(
              onRefresh: () => ref.refresh(districtsListProvider.future),
              child: districtsAsync.when(
                data: (districts) {
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final isSelected =
                          ref.watch(selectedDistrictSlugProvider) ==
                              district.slug;
                      ...
                      return ListTile(
                        ...
                        onTap: () {
                          ref
                              .read(selectedDistrictNameProvider.notifier)
                              .state = district.name;
                          ref
                              .read(selectedDistrictSlugProvider.notifier)
                              .state = district.slug;
                ...
                loading: () => const TileListSkeleton(count: 10),
