    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
              content:
                  Text('Event submitted! Needs 3 community verifications.')),
        );
        Navigator.of(context).pushReplacement(
          MaterialPageRoute(
              builder: (_) => EventDetailScreen(eventId: newEvent.id)),
        );
      }
    } catch (e) {
      if (mounted) {
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                  'New events go live after receiving 3 community verifications.',
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                    ...
                    hintText: 'e.g. Thrissur Pooram 2026'),
                validator: (val) =>
              ...
              DropdownButtonFormField<String>(
                ...
                items: const [
                  DropdownMenuItem(
                      value: 'temple', child: Text('Temple Festival')),
                  DropdownMenuItem(
                      value: 'church', child: Text('Church Feast')),
                  DropdownMenuItem(
                      value: 'dj_music', child: Text('DJ & Music Show')),
                  DropdownMenuItem(
                      value: 'beach_meetup', child: Text('Beach Meetup')),
                  DropdownMenuItem(
                      value: 'arts_culture', child: Text('Arts & Culture')),
                  DropdownMenuItem(
                      value: 'food_fest', child: Text('Food Festival')),
                  DropdownMenuItem(
                      value: 'community', child: Text('Community Gathering')),
                ],
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                    ...
                    hintText: 'e.g. Calicut Trade Centre'),
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                    ...
                    hintText: 'Street / Landmark address'),
              ),
              const SizedBox(height: 16),
              Row(
                children: [
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                    ...
                    hintText: 'Describe the event schedule, highlights, etc.'),
              ),
