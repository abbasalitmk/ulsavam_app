      ...
      body: attendeesAsync.when(
        data: (attendees) {
          if (attendees.isEmpty) {
            return const Center(child: Text('No attendees marked Going yet.'));
          }
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              final isAnonymous = attendee.displayName == 'Anonymous Festival Goer';

              return ListTile(
                leading: CircleAvatar(
                  backgroundColor: isAnonymous ? AppColors.surfaceContainerHigh : AppColors.primaryContainer,
                  ...
                  child: isAnonymous
                      ...
                      : Text(attendee.displayName[0], style: const TextStyle(color: Colors.white)),
                ),
                title: Text(
        ...
        error: (err, _) => Center(child: Text('Error loading attendees: $err')),
      ),
    );
  }
}
